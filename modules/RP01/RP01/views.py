...
MIS_COLUMNS = [
    ...
    ('Category',              'category',         'Edible Oil / Chemical / POL / Other Liquid'),
    ('Sub Category 1',        'sub_category1',    'Edible Oil / Chemical / Ph.Acid / Other'),
    ('Sub Category 2',        'sub_category2',    'optional, finer classification'),
    ('Cargo Class',           'cargo_class',      'Edible Oil / Other Liquid / Ph.Acid / POL'),
