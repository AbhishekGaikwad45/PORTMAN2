...
# Retired: the inbound callback now lives in sap_inbound.py (token-auth,
# registered on /api/sap/callback in app.py), replacing this legacy
# X-SAP-Api-Key + invoice_sap_staging handler.
